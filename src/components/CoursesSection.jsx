...
const CoursesSection = () => {
  ...
  return (
    <section className="courses-section">
      ...
      <p>By taking proactive steps to nurture mental health, we can enhance our quality of life, </p>
      <p>build resilience, and foster a sense of inner peace and balance.</p>
      </div>
